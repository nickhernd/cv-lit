...
\title{%
  \vspace{-1.5cm}
  {\includegraphics[width=3cm]{img_cam1_mask_propuesta.jpg}\hfill}\\[1cm]
...
\midrule
CAM~1 & 51 & 1.53 & \textbf{1.45} & 19.36 & \textcolor{OliveGreen}{\checkmark}~OK \\
CAM~2 & 39 & 2.64 & 3.45          & 21.09 & \textcolor{Goldenrod}{!}~Revisar \\
CAM~3 & 49 & 1.61 & 2.32          & 38.38 & \textcolor{OliveGreen}{\checkmark}~OK \\
CAM~4 & 49 & 2.78 & 3.06          & 100.01 & \textcolor{Goldenrod}{!}~Revisar \\
CAM~5 & 61 & 1.45 & \textbf{1.38} & 14.81 & \textcolor{OliveGreen}{\checkmark}~OK \\
CAM~6 & 69 & 6.14 & 4.74          & 130.62 & \textcolor{BrickRed}{\times}~Crítico \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
1 & Preparación datos + diseño interfaces & \textcolor{OliveGreen}{\checkmark} & Completado \\
2 & Calibración geométrica                & \textcolor{OliveGreen}{\checkmark} & 6 perfiles generados \\
3 & Segmentación (prototipo)              & \textcolor{OliveGreen}{\checkmark} & SAM funcional \\
4 & Extracción línea + georreferenciación & \textcolor{OliveGreen}{\checkmark} & GeoJSON en EPSG:25830 \\
5 & Validación y robustez                 & \textcolor{Goldenrod}{$\sim$}      & CAM 4 y 6 pendientes \\
6 & Integración y entrega                 & \textcolor{gray}{$\circ$}          & Próximo hito \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}[leftmargin=1.5em]
  \item[$\checkmark$] Módulo de alineación masiva no-destructiva (\texttt{batch\_alignment.py})
    \begin{itemize}
    ...
    \end{itemize}
  \item[$\checkmark$] Interfaz de validación por lotes (\texttt{BatchAlignment.vue})
  \item[$\checkmark$] Corrección de máscaras SIFT para CAM~1 (problema de gaviotas)
  \item[$\checkmark$] Integración en paso 3 del flujo de calibración (\texttt{Calibration.vue})
  \item[$\checkmark$] Documentación completa (esta memoria)
\end{itemize}
