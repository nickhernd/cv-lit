...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{mask_cam1.jpg}
  \caption{CAM~1 — horizonte del mar ($y=0{,}31$--$0{,}40$) + arena baja izq + vegetación dcha.
           Zona diseñada para evitar las gaviotas que vuelan en $y < 0{,}30$.}
  \label{fig:mask-cam1-vis}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{mask_cam2.jpg}
  \caption{CAM~2 — horizonte del mar ($y=0{,}26$--$0{,}40$) + zona derecha donde aparece
           el Peñón de Ifach ($x=0{,}58$--$0{,}88$). El peñón actúa como ancla geométrica
           muy robusta al ser una estructura rocosa estática y muy contrastada.}
  \label{fig:mask-cam2-vis}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{mask_cam3.jpg}
  \caption{CAM~3 — horizonte del mar ($y=0{,}34$--$0{,}48$) + edificios y palmeras en la
           esquina derecha ($x=0{,}72$--$1{,}00$). Las estructuras urbanas ofrecen
           features muy estables en todos los horarios.}
  \label{fig:mask-cam3-vis}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{mask_cam4.jpg}
  \caption{CAM~4 — horizonte del mar ($y=0{,}30$--$0{,}44$) + paseo marítimo/edificios en
           la esquina izquierda ($x=0{,}00$--$0{,}28$). La infraestructura urbana proporciona
           features angulares muy discriminantes.}
  \label{fig:mask-cam4-vis}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{mask_cam5.jpg}
  \caption{CAM~5 — horizonte del mar ($y=0{,}28$--$0{,}42$) + franja izquierda de
           playa/agua ($x=0{,}00$--$0{,}32$). La zona izquierda incluye la línea de
           costa y parte del mar cercano, con textura de olas reproducible.}
  \label{fig:mask-cam5-vis}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{mask_cam6.jpg}
  \caption{CAM~6 — horizonte del mar ($y=0{,}32$--$0{,}46$) + bloque de edificios en la
...
\begin{warnbox}[Nota sobre CAM\_2 — zona ``peñón'']
La región etiquetada como \texttt{penon} ($x=0{,}58$--$0{,}88$, $y=0{,}36$--$0{,}72$) en la
imagen de muestra (mayo 2026, sin visibilidad del Peñón) aparece sobre el mar abierto.
En imágenes de alta visibilidad, el Peñón de Ifach asoma en esa zona y actúa como referencia
excelente. Si la cámara opera regularmente con baja visibilidad horizontal, considerar sustituir
esta región por otra zona costera estable.
\end{warnbox}
