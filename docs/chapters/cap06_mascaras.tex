...
\begin{minted}{json}
{
  "CAM_1": {
    "regions": [
      ...
      {"label": "vegetacion_dcha", "x0": 0.60, "y0": 0.73, "x1": 1.00, "y1": 1.00}
    ]
  }
}
\end{minted}
...
\midrule
CAM~1 & Horizonte mar (y=0.39--0.48) & Arena baja + Vegetación dcha (hasta fondo) & Excluye cielo con gaviotas \\
CAM~2 & Horizonte (y=0.34--0.48)    & Vallas+Vegetación dcha (x=0.72--1.00)      & Zona estable con vallas y vegetación fija \\
CAM~3 & Horizonte (y=0.42--0.56)    & Edificio dcha (x=0.72--1.00)               & Edificio como anclaje vertical \\
CAM~4 & Horizonte (y=0.38--0.52)    & Edificio izq (x=0.00--0.28)                & Edificio como anclaje vertical \\
...
\begin{figure}[H]
  ...
  \caption{CAM~2 — horizonte del mar ($y=0{,}34$--$0{,}48$) + zona derecha con vallas y vegetación
           ($x=0{,}72$--$1{,}00$). Las vallas y masa vegetal ofrecen features estables
           cuando la visibilidad no permite distinguir el Peñón de Ifach.}
...
\begin{figure}[H]
  ...
  \caption{CAM~3 — horizonte del mar ($y=0{,}42$--$0{,}56$) + edificios y palmeras en la
...
La región etiquetada como \texttt{vallas\_vegetacion} ($x=0{,}72$--$1{,}00$, $y=0{,}36$--$0{,}72$)
cubre la franja derecha donde aparecen las vallas y la vegetación costera, que son estructuras
estáticas presentes en todas las condiciones de visibilidad. En días de alta visibilidad, el
Peñón de Ifach puede asomar en esa misma zona como referencia adicional de gran contraste.
\end{warnbox}
...
\texttt{vegetacion\_dcha} & (2764,~1957)& (4608,~2682) \\
\bottomrule
\end{tabular}
\end{table}
