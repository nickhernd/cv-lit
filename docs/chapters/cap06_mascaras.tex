...
CAM~3 & Horizonte (y=0.42--0.56)    & Edificio dcha (x=0.72--1.00, hasta el borde inferior) & Edificio como anclaje vertical \\
...
\begin{figure}[H]
  ...
  \caption{CAM~3 — horizonte del mar ($y=0{,}42$--$0{,}56$) + edificios y palmeras en la
           esquina derecha ($x=0{,}72$--$1{,}00$, hasta el borde inferior). Las estructuras urbanas
           ofrecen features muy estables en todos los horarios.}
